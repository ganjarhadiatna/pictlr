<script type="text/javascript">
	...
	function loadCover() {
		...
		OFReader.onload = function (oFREvent) {
			$("#image-cover").css('background-image', 'url('+oFREvent.target.result+')');
		}
		$('#image-cover').show();
		$('#cover-icn').hide();
	}
...
<div class="content-popup" id="compose-popup">
    <form id="form-publish" method="post" action="javascript:void(0)" enctype="multipart/form-data" onsubmit="compose()">
        <div class="compose">
            <div class="grid-1">
				...
				<label for="cover">
					...
					<div class="image-icn" id="image-cover">
